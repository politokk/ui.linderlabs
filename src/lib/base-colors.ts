...
export const baseColorsV4 = {
  ...
  neutral: {
    light: {
      ...
      foreground: "oklch(0.37 0.04 257)", // --color-neutral-950
      card: "oklch(1 0 0)", // --color-neutral-50
      "card-foreground": "oklch(0.37 0.04 257)", // --color-neutral-950
      popover: "oklch(1 0 0)", // --color-neutral-50
      "popover-foreground": "oklch(0.37 0.04 257)", // --color-neutral-950
...
export const baseColorsOKLCH = {
  default: {
    light: {
      ...
      radius: "0.625rem",
      sidebar: "oklch(0.985 0 0)", // --color-neutral-50
      "sidebar-foreground": "oklch(0.37 0.04 257)", // --color-neutral-950
      "sidebar-primary": "oklch(0.205 0 0)", // --color-neutral-900
      "sidebar-primary-foreground": "oklch(0.985 0 0)", // --color-neutral-50
      "sidebar-accent": "oklch(0.97 0 0)", // --color-neutral-100
      "sidebar-accent-foreground": "oklch(0.205 0 0)", // --color-neutral-900
  ...
  neutral: {
    light: {
      ...
      popover: "oklch(1 0 0)", // --color-neutral-50
      "popover-foreground": "oklch(0.37 0.04 257)", // --color-neutral-950
      primary: "oklch(0.44 0.00 0)", // --color-neutral-900
      "primary-foreground": "oklch(0.99 0.00 0)", // --color-neutral-50
      secondary: "oklch(0.97 0 0)", // --color-neutral-100
      "secondary-foreground": "oklch(0.205 0 0)", // --color-neutral-900
      muted: "oklch(0.97 0 0)", // --color-neutral-100
      "muted-foreground": "oklch(0.556 0 0)", // --color-neutral-500
      accent: "oklch(0.97 0 0)", // --color-neutral-100
      "accent-foreground": "oklch(0.44 0.00 0)", // --color-neutral-900
      destructive: "oklch(0.64 0.21 25)", // --color-red-600
      "destructive-foreground": "oklch(0.97 0.01 17)", // --color-red-600
      border: "oklch(0.922 0 0)", // --color-neutral-200
      input: "oklch(0.922 0 0)", // --color-neutral-200
      ring: "oklch(0.708 0 0)", // --color-neutral-400
      "chart-1": "oklch(0.98 0 0)", // --color-neutral-50
      "chart-2": "oklch(0.97 0 0)", // --color-neutral-100
      "chart-3": "oklch(0.922 0 0)", // --color-neutral-200
      "chart-4": "oklch(0.878 0 0)", // --color-neutral-300
      "chart-5": "oklch(0.834 0 0)", // --color-neutral-400
      "chart-6": "oklch(0.79 0 0)", // --color-neutral-500
      "chart-7": "oklch(0.746 0 0)", // --color-neutral-600
      "chart-8": "oklch(0.708 0 0)", // --color-neutral-700
      "chart-9": "oklch(0.646 0 0)", // --color-neutral-800
      "chart-10": "oklch(0.59 0 0)", // --color-neutral-900
      "chart-11": "oklch(0.37 0.04 257)", // --color-neutral-950
      sidebar: "oklch(0.985 0 0)", // --color-neutral-50
      "sidebar-foreground": "oklch(0.37 0.04 257)", // --color-neutral-950
      "sidebar-primary": "oklch(0.205 0 0)", // --color-neutral-900
      "sidebar-primary-foreground": "oklch(0.985 0 0)", // --color-neutral-50
